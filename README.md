...
- The volume goes back up only when the end of the break is certain: a titled song has started after the last spot (jingles, news and promos carry no title). Without that, Hushbreak stays ducked for `grace` seconds — a song that stays soft a little longer after a missed song entry beats the volume coming up in the middle of the commercials.
